...
- Dateisystemzugriff über REST-Schnittstelle (Hadoop)
 ...
 - http://docs.spring.io/spring-hadoop/docs/current/reference/html/fs.html (Verwendung in Spring)
- andere Dateisystem-REST-Schnittstellen
...
- http://www.wegwerfemailadresse.com
